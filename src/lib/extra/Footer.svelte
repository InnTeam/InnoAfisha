        ...
        <div class="row">
            ...
            <!-- <div class="col-lg-2 offset-lg-1 col-md-3 col-sm-6">
                <div class="footer-widget">
                    <h6>Shopping</h6>
                    <ul>
                        <li><a href="#a">Clothing Store</a></li>
                        <li><a href="#a">Trending Shoes</a></li>
            ...
            <div class="col-lg-2  col-md-3 col-sm-6">
                <div class="footer-widget">
                    ...
                    <ul>
                        ...
                        <li><a href="#b">Payment Methods</a></li>
                        <li><a href="#c">Delivary</a></li>
                        <li><a href="#d">Return & Exchanges</a></li>
